...
@section('content')
    ...
    <section class="mainInfo">
        <div class="container">
            ...
            <div class="welcomeMessage">
                ...
                <p class="mainMesssage">welcome to ImpactMidsouthReviews for any inquiries, please do not hesitate to contact Customer Care services</p>
            </div>
        </div>
    </section>
    ...
    <section class="levels">
        ...
        <div class="rights d-flex mb-5">
            <p class="mx-auto my-5 small">2023 Impactmidsouthreviews. All rights reserved.</p>
        </div>
